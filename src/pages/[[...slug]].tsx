...
import {
  ...
  buildPath,
  getProjectMapClient,
} from "@/utils/canvas/canvasClients";
...
export const getStaticProps = withUniformGetStaticProps({
  ...
  handleComposition: async (routeResponse, _context) => {
    ...
    const tokenConfiguration =
      !preview && process.env.WATCH !== "true"
        ? null
        : await getTokenConfiguration();
