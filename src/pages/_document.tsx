...
const getManifestClient = () => {
  ...
  if (!apiKey)
    throw new Error(
      "apiKey is not specified. ManifestClient cannot be instantiated",
    );
  if (!apiHost)
    throw new Error(
      "apiHost is not specified. ManifestClient cannot be instantiated",
    );
  if (!projectId)
    throw new Error(
      "projectId is not specified. ManifestClient cannot be instantiated.",
    );
        ...
        <Head>
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(this.props.manifest),
            }}
          />
        </Head>
