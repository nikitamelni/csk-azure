...
const Testimonial: FC<TestimonialProps> = ({
  ...
  const variantProps = {
    ...
    testimonialPrimaryImage: (
      <UniformSlot
        name={TestimonialSlots.TestimonialPrimaryImage}
        emptyPlaceholder={<div className="size-full" />}
      />
    ),
    testimonialContent: (
      <UniformSlot
        name={TestimonialSlots.TestimonialContent}
        emptyPlaceholder={<div className="h-20 w-64" />}
      />
    ),
    testimonialAuthor: (
      <UniformSlot
        name={TestimonialSlots.TestimonialAuthor}
        emptyPlaceholder={<div className="h-20 w-64" />}
      />
    ),
    testimonialSecondaryImage: (
      <UniformSlot
        name={TestimonialSlots.TestimonialSecondaryImage}
        emptyPlaceholder={<div className="h-20 w-64" />}
      />
    ),
  };
