...
type AvailableGridItemColumnsCount =
  | "1"
  | "2"
  | "3"
  | "4"
...
export type GridItemParameters = {
  displayName?: string;
  columnStart?:
    | AvailableGridItemColumnsCount
    | ViewPort<AvailableGridItemColumnsCount>;
...
export type GridItemProps = ComponentProps<GridItemParameters> &
  GridItemAdditionalProps;
